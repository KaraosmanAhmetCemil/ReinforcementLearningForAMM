...
class AutomatedMarketMaker:
    ...
    def calculate_liquidity_utilization(self, trade_volume):
        # Use current reserves for liquidity depth.
        liquidity_depth = (self.token_x_reserve + self.token_y_reserve) / 2
        ...
        # Use volatility to adjust the effective liquidity depth (the higher the volatility, the more conservative)
        factor = 1 + volatility  # e.g., if volatility is 0.02, factor becomes 1.02.
