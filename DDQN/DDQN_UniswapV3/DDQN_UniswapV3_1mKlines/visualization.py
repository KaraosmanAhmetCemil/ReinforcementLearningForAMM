...
def visualization(test_data, test_predictions_original, test_prices, liquidity_utilization, divergence_loss, slippage_loss, 
    ...
    plt.ylabel('Price')
    plt.title('Actual vs Predicted Prices – DDQN (1-Minute Klines)')
    plt.legend()
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title('Train and Validation Losses – DDQN (1-Minute Klines)')
    plt.legend()
    ...
    # Reward Over Steps
    plt.figure(figsize=(12, 6))
    plt.plot(rewards_over_steps, label='Reward Over Steps')
    plt.xlabel('Step')
    plt.ylabel('Reward')
    plt.title('Reward Over Steps – DDQN (1-Minute Klines)')
    plt.legend()
    ...
    plt.title('Liquidity Utilization Comparison – DDQN (1-Minute Klines)')
    plt.ylim(0, 100)
    ...
    plt.title('Comparison of Average Divergence Losses – DDQN (1-Minute Klines)')
    ...
    plt.title('Comparison of Average Slippage – DDQN (1-Minute Klines)')
