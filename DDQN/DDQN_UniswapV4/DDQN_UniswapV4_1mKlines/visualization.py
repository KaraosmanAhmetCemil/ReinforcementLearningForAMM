...
def visualization(viz_data, training_metrics=None):
    ...
    plt.title('Liquidity Utilization Comparison – DDQN with Hooks (1-Minute Klines)')
    plt.ylim(0, 100)
    ...
    plt.yscale('log')
    plt.title('Comparison of Average Divergence Losses – DDQN with Hooks (1-Minute Klines)')
    ...
    plt.title('Comparison of Average Slippage – DDQN with Hooks (1-Minute Klines)')
    ...
    if training_metrics is not None:
        ...
        plt.xlabel("Epoch")
        plt.ylabel("Loss")
        plt.title("LSTM Training and Validation Loss – DDQN with Hooks (1-Minute Klines)")
        plt.legend()
        plt.savefig('graphs/lstm_loss_curve_ddqn.png')
    ...
    plt.xlabel("Step")
    plt.ylabel("Reward")
    plt.title("Reward Curve over Steps – DDQN with Hooks (1-Minute Klines)")
    plt.legend()
    plt.savefig('graphs/reward_curve_ddqn.png')
    ...
    plt.ylabel("Price")
    plt.title("Predicted vs Actual Prices – DDQN with Hooks (1-Minute Klines)")
    plt.legend()
    plt.savefig('graphs/predicted_vs_actual_ddqn.png')
