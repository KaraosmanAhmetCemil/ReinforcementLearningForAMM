...
def visualization(test_data, test_predictions_original, test_prices, liquidity_utilization, divergence_loss, slippage_loss, 
    ...
    plt.legend()
    plt.savefig('graphs/actual_vs_predicted_ddqn_1h.png')
    plt.show()
    ...
    plt.legend()
    plt.savefig('graphs/train_val_loss_ddqn_1h.png')
    plt.show()
    ...
    plt.legend()
    plt.savefig('graphs/reward_over_steps_ddqn_1h.png')
    plt.show()
    ...
    plt.ylim(0, 100)
    plt.savefig('graphs/liquidity_utilization_ddqn_1h.png')
    plt.show()
    ...
    plt.savefig('graphs/divergence_loss_ddqn_1h.png')
    plt.show()
    ...
    plt.savefig('graphs/slippage_loss_ddqn_1h.png')
    plt.show()