...
def visualization(viz_data, training_metrics=None):
    ...
    plt.title('Liquidity Utilization Comparison – PPO with Hooks (1-Minute Klines)')
    plt.ylim(0, 100)
    ...
    plt.yscale('log')
    plt.title('Comparison of Average Divergence Losses – PPO with Hooks (1-Minute Klines)')
    ...
    plt.title('Comparison of Average Slippage – PPO with Hooks (1-Minute Klines)')
    ...
    if training_metrics is not None:
        ...
        plt.xlabel("Epoch")
        plt.ylabel("Loss")
        plt.title("LSTM Training and Validation Loss – PPO with Hooks (1-Minute Klines)")
        plt.legend()
    ...
    plt.xlabel("Step")
    plt.ylabel("Reward")
    plt.title("Reward Curve over Steps – PPO with Hooks (1-Minute Klines)")
    plt.legend()
    ...
    plt.ylabel("Price")
    plt.title("Predicted vs Actual Prices – PPO with Hooks (1-Minute Klines)")
    plt.legend()
