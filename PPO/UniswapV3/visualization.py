...
def visualization(test_data, test_predictions_original, test_prices, liquidity_utilization, divergence_loss, slippage_loss, seq_length,
    ...
    plt.title('Liquidity Utilization Comparison – PPO (1-Hour Klines)')
    plt.ylim(0, 100)
    plt.savefig('graphs/liquidity_utilization_ppo_1h.png')
    plt.show()
    ...
    plt.title('Comparison of Average Divergence Losses – PPO (1-Hour Klines)')
    plt.savefig('graphs/divergence_loss_ppo_1h.png')
    plt.show()
    ...
    plt.title('Comparison of Average Slippage – PPO (1-Hour Klines)')
    plt.savefig('graphs/slippage_loss_ppo_1h.png')
    plt.show()
    ...
    plt.ylabel("Price")
    plt.title("Actual vs Predicted Prices – PPO (1-Hour Klines)")
    plt.legend()
    plt.savefig("graphs/actual_vs_predicted_ppo_1h.png")
    plt.show()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("Train vs Validation Loss – PPO (1-Hour Klines)")
    plt.legend()
    plt.savefig("graphs/train_validation_loss_ppo_1h.png")
    plt.show()
    ...
    plt.xlabel("Step")
    plt.ylabel("Reward")
    plt.title("Reward over Steps – PPO (1-Hour Klines)")
    plt.legend()
    plt.savefig("graphs/reward_over_steps_ppo_1h.png")
    plt.show()