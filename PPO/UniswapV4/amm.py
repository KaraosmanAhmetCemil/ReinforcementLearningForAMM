...
class AutomatedMarketMaker:
    ...
    def get_dynamic_trade_size(self, volatility=0.01):
        ...
        base_trade = liquidity_depth * 0.005  # 0.5% base trade
        ...
        # Reduced volatility sensitivity from 40 to 20 to boost trade size
        sensitivity = 1 + volatility * 20 + recent_trade_ratio * 15
